CLASS zcl_ce_rap_agency_1234 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zrap_1234z_travel_agency_es5-agencyid.
    TYPES t_business_data TYPE TABLE OF zrap_1234z_travel_agency_es5.
...
CLASS zcl_ce_rap_agency_1234 IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_1234' ).
